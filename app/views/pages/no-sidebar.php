        ...
        <section>
            <div class="feature-posts">
                ...
                <a href="single-post.html" class="feature-post-item">
                    ...
                    <div class="feature-post-caption">Fashion</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src="../../../public/imgs/img-2.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Travel</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src="../../../public/imgs/img-3.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Temporibus Simile</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src="../../../public/imgs/img-4.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Air Lines</div>
                </a>
            </div>
        </section>
        <hr>
                ...
                <div class="row">                       
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="../../../public/imgs/blog-3.jpg" alt="" class="w-100">
                ...
                <div class="row">                       
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="../../../public/imgs/blog-4.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="../../../public/imgs/blog-5.jpg" alt="" class="w-100">
                ...
                <div class="row">                       
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="../../../public/imgs/blog-1.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src="../../../public/imgs/blog-7.jpg" alt="" class="w-100">
